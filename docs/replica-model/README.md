...
| Relationship-evidence wait and retry triggers | [RZ §9.1](relationships.md#deferred-delivery); resolution accounting in [RZ §10.1](relationships.md#shared-accounting-and-lost-wait-state) | [VE pending-pair evidence](vault-events.md#receipt-and-relationship-evidence), [DD receive procedure](distributed-delivery.md#receive-a-message), [RM pickup ACK](replica-mediation.md#messages-received) |
