...
reads or writes this folder any more. Version 3 is the [replica model](replica-model/README.md): one SQLite vault, DASL objects, channels.
Kept as the record of what version 2 was.
