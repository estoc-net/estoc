...
describe("keystore", () => {
  ...
  it("parseKeystore rejects malformed documents", () => {
    ...
    expect(() => parseKeystore('{"version":2,"keys":[]}')).toThrow(/v2 seed keystore/);
    expect(() => parseKeystore('{"version":3,"keys":[]}')).toThrow(/v3 seed keystore/);
    expect(() => parseKeystore('{"version":4,"keys":[]}')).toThrow(/unsupported keystore version/);
