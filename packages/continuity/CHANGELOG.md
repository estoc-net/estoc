...
- `@estoc/continuity/from-prior`: inspection, verification, binding and
  creation of `from_prior` under the `estoc-from-prior/1` profile:
  did:peer:4 parties, Ed25519, no validity window, no clock. The signing
