...
describe("receipt eligibility and the required receiving set", () => {
  ...
  it("lets a live entity and a retired entity receive alike, until the route under it is terminal", async () => {
  ...
  it("settles what is terminal before what is missing: a document that sends elsewhere is terminal without its route, a retired entity without its route only waits", async () => {
    const s = new Scene();
