...
/** An operation the view in hand does not do — a write asked of the read-only view of a snapshot, a mutation asked inside a keep callback or through a held view whose operation has ended — refused before consuming a source or minting anything. */
